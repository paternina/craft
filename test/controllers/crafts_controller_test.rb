...
class CraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create craft" do
    assert_difference('Craft.count') do
      post crafts_url, params: { craft: { description: @craft.description, title: @craft.title, user_id: @craft.user_id } }
    end
  ...
  test "should update craft" do
    patch craft_url(@craft), params: { craft: { description: @craft.description, title: @craft.title, user_id: @craft.user_id } }
