class CraftsController < ApplicationController
  before_action :set_craft, only: [:show, :edit, :update, :destroy, :like, :unlike]
  before_action :authenticate_user!, only: [:new, :edit, :update, :destroy, :like, :unlike]
  ...
  private
    ...
    def craft_params
      params.require(:craft).permit(:title, :description, :user_craft)
    end
end
