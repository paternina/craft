	...
	var Crafts = {
		previewCraft() {
			if (window.File && window.FileList && window.FileReader) {
				...
				const fileInput = document.getElementById('craft_user_craft');
				const previewImage = document.getElementById('previewImage');
				const newCraftForm = document.getElementById('new_craft');
		...
		craftHover() {
			$('.craft').hover(function() {
				$(this).children('.craft-data').toggleClass('visible');
			});
		}
